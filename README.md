...
7. Install the MinkowskiEngine.
   git clone https://github.com/NVIDIA/MinkowskiEngine.git

8. After install Minkowski Engine, Find the following files and Add headers.
...
9. After change, put export MAX_JOBS=2 in terminal (Minkowski 빌드할때 컴퓨터 과부화로 멈추는거 방지)
10. Run this in terminal to build MinkowskiEngine
...
11. https://github.com/graspnet/anygrasp_sdk 사이트를 들어가 먼저 license 등록 후 사이트의 안내대로 설치
