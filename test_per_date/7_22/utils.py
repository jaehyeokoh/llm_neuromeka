...
def anygrasp_message(data, mask_base64, mask_shape,target_boundary_info):
    msg = AIMessage(
    content="",
    tool_calls=[{
        "name": "anygrasp_analyze",
        "args": {"data": data, "mask_base64": mask_base64, "mask_shape":mask_shape, "target_boundary_info":target_boundary_info},
        "id": str(uuid4()),
        "type": "tool_call"
        }]
    )
