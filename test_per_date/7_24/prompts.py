...
# Step-by-step:  
# 1. Look at the image and describe what is visually present (briefly).  
# 2. Match the detected objects against the given object list.  
# 3. Reason step by step using minimal language.  
# 4. Do not skip any step, even if it seems obvious.  
...
# If **no target objects are found**, output:  
# output:  
# None
...
{
  "chain_of_thought": [
    "thought with very short sentence"
  ],
  "answer": [
