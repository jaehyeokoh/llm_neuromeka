...
** IMPORTANT ** : when you describe the color, then use color of top of object (e.g. blue silver can -> silver can)
For example, 'white box', 'silver can', 'green bottle'.
...
RULES:                                            
1. You can only control the gripper’s position and its roll, pitch, yaw, and gripper on/off.  
