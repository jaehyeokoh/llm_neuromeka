...
4. When comparing object names, allow for **partial color matches**:
  - If the object shares a dominant or significant color with the target name (e.g., "blue-silver can" vs "silver can"), consider it a match.
  - Do not require exact color-name matching.
  - Prioritize visual similarity over strict textual equality.
