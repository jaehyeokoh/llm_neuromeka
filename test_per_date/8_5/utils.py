...
def generate_point_cloud_message(mask_base64,mask_shape, obj_height,tool_pos ):
    msg = AIMessage(
    content="",
    tool_calls=[{
        "name": "generate_completed_point_cloud",
        "args": {"mask_base64_list":mask_base64, "mask_shape_list":mask_shape,"obj_height_list":obj_height,"tool_pos":tool_pos},
        "id": str(uuid4()),
        "type": "tool_call"
        }]
    )
